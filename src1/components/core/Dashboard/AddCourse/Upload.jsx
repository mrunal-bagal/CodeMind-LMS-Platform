...
export default function Upload({
  ...
  const { getRootProps, getInputProps, isDragActive } = useDropzone({
    ...
    onDrop,
    noClick: true, // Prevents auto-click so we control it manually
  });
  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <div
        {...getRootProps({
          className: `cursor-pointer flex min-h-[250px] items-center justify-center rounded-md border-2 border-dotted border-richblack-500 
        ...
        {previewSource ? (
          ...
          <div className="flex w-full flex-col items-center p-6">
            ...
            <p className="mt-2 max-w-[200px] text-center text-sm text-richblack-200">
              ...
              <span className="font-semibold text-yellow-50">click here</span> to browse
            </p>
