...
import backgroundImg4 from '../assets/Images/random bg img/coding bg4.png'
                        ...
                        <div className='flex flex-col lg:flex-row gap-5 mb-10 mt-[95px]'>
                            ...
                            <div className='flex flex-col gap-10 w-full lg:w-[40%] items-start'>
                                <div className='text-[16px]'>
                                    The modern CodeMind is the dictates its own terms. Today, to be a competitive specialist requires more than professional skills.
                                </div>
                                <CTAButton active={true} linkto={"/signup"}>
                                    <div>
                                        Learn more
